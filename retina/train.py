...
def launch_fire(
    ...
    run_name="7-train",
    output_dir="../output/",
    data_dir="F:\\1\\EyeTracking\\stage6_retina_gaze\\evs_ini30\\evs_ini30",
    path_to_run="F:\\1\\EyeTracking\\stage6_retina_gaze\\retina_v4\\output\\wandb\\train-1",
    ...
    if path_to_run != None:
        # trainer.load("F:\\1\\EyeTracking\\stage6_retina_gaze\\retina_v4\\output\\wandb\\train-1\\step_791.pt")
        trainer.load("../retina_snn/saved_model_step_791.pt")
